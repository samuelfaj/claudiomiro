...
exports.ParallelUIRenderer = void 0;
...
class ParallelUIRenderer {
    ...
    start(stateManager, progressCalculator) {
        ...
        if (logger_1.default && typeof logger_1.default.stopSpinner === 'function') {
...
exports.ParallelUIRenderer = ParallelUIRenderer;
exports.default = ParallelUIRenderer;
//# sourceMappingURL=parallel-ui-renderer.js.map