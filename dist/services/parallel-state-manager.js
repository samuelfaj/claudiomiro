...
exports.ParallelStateManager = void 0;
class ParallelStateManager {
    ...
    initialize(tasks) {
        ...
        entries.forEach(([taskName, taskConfig]) => {
            ...
            const status = taskConfig && taskConfig.status
                ? taskConfig.status
                : 'pending';
...
exports.ParallelStateManager = ParallelStateManager;
ParallelStateManager.instance = null;
exports.default = ParallelStateManager;
//# sourceMappingURL=parallel-state-manager.js.map