...
const progress_calculator_1 = require("../progress-calculator");
describe('ProgressCalculator', () => {
    describe('calculateProgress', () => {
        it('should return 0 for empty task states', () => {
            expect(progress_calculator_1.ProgressCalculator.calculateProgress({})).toBe(0);
        });
        it('should return 0 for null or undefined input', () => {
            expect(progress_calculator_1.ProgressCalculator.calculateProgress(null)).toBe(0);
            expect(progress_calculator_1.ProgressCalculator.calculateProgress(undefined)).toBe(0);
        });
        it('should return 0 for non-object input', () => {
            expect(progress_calculator_1.ProgressCalculator.calculateProgress('invalid')).toBe(0);
            expect(progress_calculator_1.ProgressCalculator.calculateProgress(123)).toBe(0);
        });
        it('should calculate 0% progress for tasks with no steps completed', () => {
            ...
            expect(progress_calculator_1.ProgressCalculator.calculateProgress(taskStates)).toBe(0);
        });
        ...
        it('should calculate 100% progress when all tasks are completed', () => {
            ...
            expect(progress_calculator_1.ProgressCalculator.calculateProgress(taskStates)).toBe(100);
        });
        it('should calculate 50% progress for failed tasks', () => {
            ...
            expect(progress_calculator_1.ProgressCalculator.calculateProgress(taskStates)).toBe(50);
        });
        ...
        it('should handle mixed task states', () => {
            ...
            expect(progress_calculator_1.ProgressCalculator.calculateProgress(taskStates)).toBe(33);
        });
    });
    // Type safety tests
    describe('Type safety', () => {
        it('should enforce TaskState interface', () => {
            ...
            const progress = progress_calculator_1.ProgressCalculator.calculateProgress(taskStates);
        ...
        it('should handle edge cases with proper types', () => {
            ...
            const progress = progress_calculator_1.ProgressCalculator.calculateProgress(edgeCaseStates);
            expect(typeof progress).toBe('number');
        });
    });
    describe('Edge cases', () => {
...
//# sourceMappingURL=progress-calculator.test.js.map