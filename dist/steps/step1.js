...
class Step1 {
     ...
     */
    static async execute(mode = 'auto') {
        logger.newline();
        ...
        try {
            await claude_executor_1.ClaudeExecutor.execute(prompt);
            logger.stopSpinner();
    ...
    static readTasks() {
        ...
        return fs
            ...
            .filter(name => {
            const fullPath = path.join(state_1.default.claudiomiroFolder, name);
     ...
     */
    static handleSingleTask(taskName) {
        if (!state_1.default.claudiomiroFolder) {
            throw new Error('Claudiomiro folder not set');
        }
        const taskMdPath = path.join(state_1.default.claudiomiroFolder, taskName, 'TASK.md');
     ...
     */
    static readTaskContents(tasks) {
        if (!state_1.default.claudiomiroFolder) {
            throw new Error('Claudiomiro folder not set');
        }
        const taskContents = {};
        for (const taskName of tasks) {
            const taskMd = path.join(state_1.default.claudiomiroFolder, taskName, 'TASK.md');
            const promptMd = path.join(state_1.default.claudiomiroFolder, taskName, 'PROMPT.md');
     ...
     */
    static buildTasksDescription(tasks, taskContents) {
        return tasks
            .map(taskName => {
            return `### ${taskName}
**TASK.md:**
...
`;
     ...
     */
    static applySequentialDependencies(tasks) {
        if (!state_1.default.claudiomiroFolder) {
            throw new Error('Claudiomiro folder not set');
        }
     ...
     */
    static getAutoModePrompt(tasksDescription, tasks) {
        return `
...
`;
     ...
     */
    static getHardModePrompt(tasksDescription, tasks) {
        return `
