...
describe('TerminalRenderer', () => {
  ...
  describe('constructor', () => {
    it('should initialize with lastLineCount set to 0', () => {
      expect((renderer as any).lastLineCount).toBe(0);
    });
  });
  ...
  describe('renderBlock', () => {
    it('should render lines correctly', () => {
      ...
      expect((renderer as any).lastLineCount).toBe(3);
      writeSpy.mockRestore();
    });
    ...
    it('should handle null or undefined lines', () => {
      ...
      renderer.renderBlock(null as any);
      expect((renderer as any).lastLineCount).toBe(0);

      renderer.renderBlock(undefined as any);
      expect((renderer as any).lastLineCount).toBe(0);
    ...
    it('should handle non-array input', () => {
      ...
      renderer.renderBlock('not an array' as any);
      expect((renderer as any).lastLineCount).toBe(0);
  ...
  describe('reset', () => {
    it('should reset lastLineCount to 0', () => {
      (renderer as any).lastLineCount = 5;
  ...
  describe('Type safety', () => {
    it('should enforce proper parameter types', () => {
      ...
      const width: number = renderer.getTerminalWidth();
